...
app.controller('HeaderCtrl', [
  ...
  function ($scope, $rootScope, filterFilter, $http) {
    $scope.searching = function () {
      ...
      $rootScope.search = $scope.search;  // rootscope me sert a controller des données en dehors de ma scope courante
    };
  }
]);
app.controller('UsersCtrl', [
  ...
  function ($scope, $filter, $http) {
    ...
    var users;
    $http.get('https://jsonblob.com/api/jsonBlob/57a59a90e4b0dc55a4eae792').success(function (response) {
